...
AceShell 是一个跨平台（Windows / macOS / Linux）网络终端管理工具，基于 **Go + Wails v3 + Vue 3 + TypeScript + Naive UI** 构建，支持 SSH / Telnet / 串口 / SFTP / HTTP 五类会话的统一管理。

## 功能特性

- **会话管理**：五类会话树形组织、加密存储、主机指纹 TOFU 校验、密码与密钥登录、串口参数持久化
