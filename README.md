...
- **智能助手**：内置 AI 运维智能体——深度思考先行、MCP 工具总线（Streamable HTTP / SSE / stdio / 内置）、联网搜索（必应 → 真实浏览器渲染 → DuckDuckGo 三级回退，零 API Key）、Context7 文档检索预置、计划/手动/自动三档权限、执行期间标签页遮罩防误操作
...
- **首次使用引导**：欢迎向导选择界面语言与是否开启智能助手，配置持久化仅弹一次
